...
export const BASE_MAP = {
  ...
  links: [],
  resourceZones: [],
  terrainMapImageUrl: "/assets/maps/terrain/mockup-terrain-map.png",
  terrainMapMetadataUrl: "/data/maps/terrain/mockup-terrain-map.metadata.json",
};
...
function applyMapDocumentToBaseMap(mapDocument) {
  ...
  const normalizedTowns = sourceTowns.map((town, index) =>
    normalizeTownRecord(town, BASE_TOWNS[index % BASE_TOWNS.length], index)
  );
